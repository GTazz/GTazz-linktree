        ...
        <div className="card-content">
          ...
          <div className="contact">
            ...
            <div>
              <p className="email"></p>
              <p>:&nbsp;</p>
              <p>contact@gtazz.dev</p>
            </div>
            <div>
              <p className="phone"></p>
              <p>:&nbsp;</p>
              <p>+55 (11) 96374-9115</p>
            </div>
          </div>
          <hr />
          <div className="links">
            ...
            <div>
              <a className="linkedin" href="https://www.linkedin.com/in/gabriel-tazz/" target="_blank" rel="noopener">
                <svg aria-label="LinkedIn icon" role="img" fill="currentColor" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-143 145 512 512" xml:space="preserve">
              ...
              <a className="github" href="https://github.com/GTazz" target="_blank" rel="noopener">
                <svg aria-label="GitHub icon" role="img" fill="currentColor" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <g id="SVGRepo_bgCarrier" stroke-width="0" />
                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
              ...
              <a className="youtube" href="https://www.youtube.com/@GabTazz" target="_blank" rel="noopener">
                <svg fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 97.75 97.75" xml:space="preserve">
                  <g id="SVGRepo_bgCarrier" stroke-width="0" />
                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
              ...
              <a className="instagram" href="https://www.instagram.com/tazz.py/" target="_blank" rel="noopener">
                <svg aria-label="Instagram icon" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path
